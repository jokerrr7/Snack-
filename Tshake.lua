...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1765160742,1535803411}
print("\27[34m"..[[
...
if tonumber(user_id) == tonumber(1535803411) then  
var = "مطور السورس"
...
Text = [[
❈┇ Welcome to Source
❈┇[ TEM SNACK ](t.me/SNACK_772)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
❈┇[Surus programmer](t.me/eljo_ker_m)

❈┇[Surus developer ](t.me/UU_0p)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
]]
send(msg.chat_id_, msg.id_,Text)
end
...
↕️┇رفع/كشف القيود
↕️┇تنزيل الكل
❈┇تفعيل/تعطيل الايدي بالصوره❈┇تفعيل/تعطيل الايدي❈┇تفعيل/تعطيل ردود المطور❈┇تفعيل/تعطيل اللعبه/الالعاب❈┇تفعيل/تعطيل ردود المدير❈┇تفعيل/تعطيل اطردني❈┇تفعيل/تعطيل الرفع❈┇تفعيل/تعطيل الحظر/الطرد❈┇تفعيل/تعطيل الرابط/جلب الرابط❈┇تفعيل/تعطيل اوامر التحشيش
